...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center h-[calc(100vh-200px)]">
      ...
      <h1 className="text-2xl font-bold mb-2">Under Migration</h1>
      <p className="text-muted-foreground max-w-md">This page is currently being migrated to the new system database. Please check back later.</p>
    </div>
  );
}
